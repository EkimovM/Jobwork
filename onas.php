		...
		<div class="body">		
			...
			<ul class="sky-mega-menu sky-mega-menu-anim-scale sky-mega-menu-response-to-icons">
                ...
                <li aria-haspopup="true">
					...
					<div>
							<form action='onas.php' method='post'>
    ...
    <?
					   if ($_POST['reg']=='Зарегистрироваться')
					   {
						   ...
						   if ($pass1 == $pass2)
						   {
							    ...
							    $result=mysqli_query($conn,$query);
							    echo "<br><br>Регистрация прошла успешно, <a href='onas.php'>Авторизуйтесь</a><br><br>";
						   }
						   else
						   {
							   echo "<br><br>Пароли не совподают, попробуйте еще раз <a href='onas.php'>Зарегистрироваться</a><br><br>";
						   }
					   }
					   else
					   {
	       ...
	       <section class='section2'>
			    <center>
					...
					if ($_POST['auto']=='Войти')
					{
						...
						{
							echo "<br><br>Данные не верны попробуйте еще раз <a href='onas.php'>Авторизоваться</a><br><br>";
						}
					}
					else
					{
				 ...
				 <div class='tovar'>
				    <center>
						...
						<form action='korzina.php' method='post'>
							 ...
							 <input type='submit' name='tovar' value='В корзину' style="font-family: LetoTextSansDefect;">
						</form>
						...
						<div class='buy'>
						     <form action='tovar.php' method='post'>
							    <input type='hidden' name='id' value='<? echo $row[0]; ?>'>
								<input type='submit' name='tovar' value='Подробнее' style="font-family: LetoTextSansDefect;">
							 </form>
						</div>
					</center>
				 </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <p class="p22">Мы компания Jobwork</p>
        <p class="p22">Наши преимущества<br>
            -Личный контакт с работодателем, позволяющий Вам показать свои положительные качества.
            <br>
            -Возможность побывать в офисе фирмы и составить впечатление о ней.
            <br>
            -Приобретение опыта трудоустройства.
            <br>
            -Большое количество вакансий.
            <br>
            -Вам не навязывают какие-либо варианты.
            <br>
            -По ходу дела Вы можете выбрать курсы для повышения квалификации, овладения смежной профессией.
</p>
      </div>
      <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <img src="img/1111.jpg" class="img22" width='400px';>
      </div>
    </div>
  </div>
  <div class="container">
    <div class="row">
      <div class="col-12">
        <h2 class="h222">Навигация по сайту</h2>
      </div>
    </div>
  </div>
  <div class="container">
    <div class="row">
      <div class="col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3">
        <p class="p22"><a href="index.php">Главная</a></p>
        <p class="p22"><a href="index.php">Вакансии</a></p>
      </div>
      <div class="col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3">
        <p class="p22"><a href="kontakti.php">Обратная связь</a></p>
        <p class="p22"><a href="onas.php">О нас</a></p>
      </div>
    </div>
  </div>
  <div class="container">
    <div class="row">
      <div class="col-12">
        <h2 class="h222">Контакты для связи</h2>
      </div>
    </div>
  </div>
  <div class="container">
    <div class="row">
      <div class="col-12">
        <p class="p22">Телефон: 8-(800)-555-35-35</p>
        <p class="p22">Почта: <a href="mailto: Jobwork@gmail.com">Jobwork@gmail.com</a></p>
        <p class="p22">Телеграм: @Jobwork</p>
      </div>
    </div>
  </div>
                </div>
